...
; Bright-red TODOs etc.
 ...
 (modify-face 'font-lock-note-face "ForestGreen" nil nil t nil t nil nil)
...
; Toggles one buffer to fullscreen.
...
(define-key global-map (kbd"<f12>") 'toggle-maximize-buffer)
...
(set-variable 'grep-command "findstr -s -n -i -l \"TODO\" *.h *.cpp ")
...
(custom-set-variables
 ...
 '(auto-show-mode t t)
 '(custom-safe-themes
   '("ba4ab079778624e2eadbdc5d9345e6ada531dc3febeb24d257e6d31d5ed02577" "5d59bd44c5a875566348fa44ee01c98c1d72369dc531c1c5458b0864841f887c" default))
...
(defun post-load-stuff ()
  ...
  (define-key global-map "\e-" 'lsp-find-definition)
  (define-key global-map "\e_" 'lsp-find-declaration)
  (define-key global-map "\e*" 'xref-find-definitions-other-window)
)
